...
<?php
            ...
            if(isset($_POST['input'])){
				...
				$cek = mysqli_query($koneksi, "SELECT * FROM cuti WHERE tanggal_mulai_cuti='$tanggal_mulai_cuti' AND id='$id'");
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO cuti (id, nik, nama, tanggal_ajuan, tanggal_mulai_cuti, tanggal_selesai_cuti, jumlah_cuti, jenis_cuti, keperluan, status)
															VALUES('$rand','$nik','$nama','$tanggal_ajuan','$tanggal_mulai_cuti','$tanggal_selesai_cuti','$jumlah_cuti','$jenis_cuti','$keperluan','$status')") or die(mysqli_error());
						if($insert){
										...
										<div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tanggal_ajuan" name="tanggal_ajuan" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" placeholder="Tanggal Ajuan Cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tanggal_mulai_cuti" name="tanggal_mulai_cuti" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" placeholder="Tanggal Mulai Cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="tanggal_selesai_cuti" name="tanggal_selesai_cuti" class="input-group date form-control" data-date="" data-date-format="yyyy-mm-dd" placeholder="Tanggal Selesai Cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
										<div class="form-group row">
                                            <div class="col-md-12">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="jumlah_cuti" name="jumlah_cuti" class="form-control" placeholder="Jumlah Cuti" required="required">
                                                </div>
                                            </div>
                                        </div>
                                         <div class="form-group row">
