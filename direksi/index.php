            ...
            <div class="container-fluid">
                <div class="animated fadeIn">
                    <div class="row">
						...
						<div class="col-6 col-lg-3">
							...
							?>
								<div class="card-body p-3 clearfix">
                                    <i class="fa fa-book bg-info p-3 font-2xl mr-3 float-left"></i>
								     <div class="h5 text-info mb-0 mt-2"><?php echo $data2['sisa_cuti'] ?></div>
                    ...
                    ?>
                                ...
                                <div class="card-footer px-3 py-2">
                                    <a class="font-weight-bold font-xs btn-block text-muted" href="approvedcuti.php">Detail Approved <i class="fa fa-angle-right float-right font-lg"></i></a>
                                </div>
                            </div>
                        </div>
                        <!--/.col-->
						<div class="col-6 col-lg-3">
                            <div class="card">
                            <?php $tampil2=mysqli_query($koneksi, "select * from cuti where status='Process'");
