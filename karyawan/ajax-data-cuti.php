...
// datatable column index  => database column name
    ...
    1 => 'nik', 
	2 => 'nama',
    3 => 'tanggal_mulai_cuti',
	4 => 'tanggal_selesai_cuti',
    5 => 'jumlah_cuti',
	6 => 'jenis_cuti',
	7 => 'pesan',
    8 => 'status'
...
$sql = "SELECT id, nik, nama, tanggal_mulai_cuti, tanggal_selesai_cuti, jumlah_cuti, jenis_cuti, pesan, status";
$sql.=" FROM cuti";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
                     <a href="approvecuti.php?true=true&id='.$row['id'].'"  data-toggle="tooltip" title="Approve Cuti" onclick="return confirm(\'Anda yakin approve cuti '.$row['nama'].'?\')" class="btn btn-sm btn-info"> <i class="fa fa-check"> </i> Approve </a>
	                 <a href="approvecuti.php?false=false&id='.$row['id'].'"  data-toggle="tooltip" title="Reject Cuti" onclick="return confirm(\'Anda yakin reject cuti '.$row['nama'].'?\')" class="btn btn-sm btn-warning"> <i class="fa fa-close"> </i> Reject</a>
				     ...
				     <a href="approvecuti.php?aksi=delete&id='.$row['id'].'"  data-toggle="tooltip" title="Delete" onclick="return confirm(\'Anda yakin akan menghapus data '.$row['nama'].'?\')" class="btn btn-sm btn-danger"> <i class="fa fa-trash"> </i> </a>
	                 </center></td>';		
