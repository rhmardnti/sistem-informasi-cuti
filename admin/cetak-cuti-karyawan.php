...
<div id="wrapper">
    ...
    ?>
        ...
        <td><p style="text-align:left; font-size: 12px; font-weight:bold;"><?php $timezone = time() + (60 * 60 * 8);
         echo gmdate('Y/m/d H:i:s', $timezone); ?> </p></td>
        </tr>
        <tr>
    ...
    <div id="content">
        ...
        <?php
            ...
            <tr>
                ...
                <td style="width:20%;"><b>Tanggal Ajuan Cuti</b></td>
                <td style="width:20%;"><b>Tanggal Mulai Cuti</b></td>
                <td style="width:20%;"><b>Tanggal Selesai Cuti</b></td>
                <td style="width:10%;"><b>Jumlah Cuti</b></td>
				<td style="width:15%;"><b>Jenis Cuti</b></td>
				<td style="width:25%;"><b>Keperluan</b></td>
				<td style="width:15%;"><b>Pesan</b></td>
            ...
            <tr>
                ...
                <td style="width:20%;" class="mono"><b><center><?php echo $data1['tanggal_ajuan']; ?></center></b></td>
                <td style="width:20%;" class="mono"><b><center><?php echo $data1['tanggal_mulai_cuti']; ?></center></b></td>
                <td style="width:20%;" class="mono"><b><center><?php echo $data1['tanggal_selesai_cuti']; ?></center></b></td>
                <td style="width:10%;" class="mono"><b><center><?php echo $data1['jumlah_cuti']; ?></center></b></td>
				<td style="width:15%;" class="mono"><b><center><?php echo $data1['jenis_cuti']; ?></center></b></td>
				<td style="width:25%;" class="mono"><b><center><?php echo $data1['keperluan']; ?></center></b></td>
				<td style="width:15%;" class="mono"><b><center><?php echo $data1['pesan']; ?></center></b></td>
