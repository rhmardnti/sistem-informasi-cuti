...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
    ...
    $nestedData[] = '<td><center>
					 <a href="form-cuti.php?id='.$row['id'].'"  data-toggle="tooltip" title="Cetak" class="btn btn-sm btn-secondary"> <i class="fa fa-print"></i> </a>
				    <a href="cuti.php?true=true&id='.$row['id'].'"  data-toggle="tooltip" title="Approve Cuti" onclick="return confirm(\'Anda yakin approve cuti '.$row['nama'].'?\')" class="btn btn-sm btn-info"> <i class="fa fa-check"> </i></a>
                     ...
                     <a href="detail-cuti.php?id='.$row['id'].'"  data-toggle="tooltip" title="View Detail" class="btn btn-sm btn-success"> <i class="fa fa-search"></i> </a>
